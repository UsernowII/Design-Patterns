...
//const editor = new EditorClear(new HtmlPainter(content) );
const editor = new EditorClear(new CanvasPainter(canvas) );

range.addEventListener("input", (e)=>{ // change the bar
